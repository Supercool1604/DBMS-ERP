...
def marks_list(request, stud_id):
    ...
    for ass in ass_list:
        try:
            ...
            sc.save()
            sc.marks_set.create(type='I', name='Minor 1')
            sc.marks_set.create(type='I', name='Minor 2')
            sc.marks_set.create(type='I', name='Quiz 1')
            sc.marks_set.create(type='E', name='Quiz 2')
            sc.marks_set.create(type='E', name='Quiz 3')
            sc.marks_set.create(type='S', name='Major Exam')
        sc_list.append(sc)
